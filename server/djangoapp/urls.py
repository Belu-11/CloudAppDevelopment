...
urlpatterns = [
    ...
    path(route='api/dealership/state/<str:state>', view=views.get_state_dealerships, name="state_dealerships"),
    path(route='dealer/<int:dealer_id>/new-review', view=views.add_review, name="add_review")
